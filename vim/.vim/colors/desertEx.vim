...
highlight MatchParen guifg=cyan guibg=NONE gui=NONE ctermfg=51 cterm=NONE
...
hi CursorLine term=bold cterm=none ctermfg=4

hi CursorLine ctermbg=8 ctermfg=none "8 = dark gray
