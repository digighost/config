...
OPERATIONS
  ...
  bookmarklist      print the list of directory bookmarks
...
EXAMPLES
  ...
  bookmarklist -l                  long list
  bookmarklist -p                  path list
  bookmarklist "*x"                list all of all bookmarks *x
  bookmarklist -l "*x"             long list all of all bookmarks *x
EOF
}
...
# "bookmarklist" - Saved bookmark Listing
